...
PRODUCT_COPY_FILES += \
    device/motorola/clark/rootdir/etc/init.clark.rc:root/init.clark.rc \
    device/motorola/clark/rootdir/etc/init.clark.usb.rc:root/init.clark.usb.rc \
    device/motorola/clark/fstab.qcom:root/fstab.qcom \
    device/motorola/clark/twrp.fstab:recovery/root/etc/twrp.fstab \
    device/motorola/clark/rootdir/etcueventd.clark.rc:root/ueventd.clark.rc

# Input device files for clark
PRODUCT_COPY_FILES += \
    device/motorola/clark/gpio-keys.kl:system/usr/keylayout/gpio-keys.kl

PRODUCT_COPY_FILES += \
    device/motorola/clark/audio_policy.conf:system/etc/audio_policy.conf \
    device/motorola/clark/audio_effects.conf:system/etc/audio_effects.conf

PRODUCT_COPY_FILES += \
    device/motorola/clark/media_profiles.xml:system/etc/media_profiles.xml \
